...
set DFS_IRESSPACKAGE_DIR=IRESS Pro-19.2.06
set DFS_IRESSCANADAPACKAGE_DIR=IOS Plus-19.1.932
set DFS_IRESSRETAILPACKAGE_DIR=IOSPlusRetail-19.1.932
...
echo Installing SetLocaleCanada.reg.
REGEDIT.EXE /S SetLocaleCanada.reg

echo Installing Filters.reg.
REGEDIT.EXE /S Filters.reg

echo Installing OrderPadFilters.reg.
REGEDIT.EXE /S OrderPadFilters.reg

echo Installing PortfolioFilters.reg.
REGEDIT.EXE /S PortfolioFilters.reg

echo Installing RegTimeZone.reg.
...
:ProgramFilesx86
copy /v /y "Sample_IOS_Plus_Option_Position_Scan.xlsm" "%ProgramFiles(x86)%\IRESS Market Technology\IRESS"
copy /v /y "Sample_IOS_Plus_Retrieval.xlsm" "%ProgramFiles(x86)%\IRESS Market Technology\IRESS"
...
copy /v /y "Sample_IOS_Plus_Retrieval.xlsm" "%ProgramFiles%\IRESS Market Technology\IRESS"
copy /v /y "Sample_IOS_Plus_Option_Position_Scan.xlsm" "%ProgramFiles%\IRESS Market Technology\IRESS"
