namespace IressPro.Packager.AppSettings
{
  ...
  {
    public const string BatCtx_IrsIos___Ips = @"
@echo off

rem ****
rem ****  This script will run the three installation packages that make up the 
rem ****  Iress Canada client application with IPS, in silent mode.
rem ****
...
echo.
echo Installing IRESS Canada Client Packages with IPS.
echo.
