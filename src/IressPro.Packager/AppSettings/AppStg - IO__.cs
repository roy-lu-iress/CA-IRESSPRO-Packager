namespace IressPro.Packager.AppSettings
{
  ...
  {
    public const string BatCtx_IrsIos______ = @"
@echo off

rem ****
rem ****  This script will run the two installation packages that make up the 
rem ****  Iress Canada client application, in silent mode.
rem ****

rem ****
rem ****  Update the following two variables with each new version.
rem ****
...
echo.
echo Installing IRESS Canada Client Packages.
echo.
