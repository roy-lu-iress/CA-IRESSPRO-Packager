namespace IressPro.Packager.AppSettings
{
  ...
  {
    public const string BatCtx_IrsIosRtlIps = @"
@echo off
...
set DFS_IRESSRETAILIOSPACKAGE_DIR=IOS Plus Retail IPS
...
:RetailIpsInstall
echo Installing IOS Plus Retail IPS Client Plugin...
cd ""%DFS_IRESSRETAILIOSPACKAGE_DIR%""
rem Setup.exe /S /V/qb+   Replaces with below as per CI-299
Setup.exe /qb
